...
def main():
    ...
    runner = LargeDecodeRunner.create(
        ...
        min_overlap=int(large_cfg.get("min_overlap", large_cfg.get("border_min_overlap", 1))),
        iou_threshold=float(large_cfg.get("iou_threshold", large_cfg.get("border_iou_threshold", 0.0))),
        one_sided_threshold=float(large_cfg.get("one_sided_threshold", large_cfg.get("border_one_sided_threshold", 0.9))),
        one_sided_min_size=int(large_cfg.get("one_sided_min_size", 0)),
        affinity_threshold=float(large_cfg.get("affinity_threshold", large_cfg.get("border_affinity_threshold", 0.0))),
