...
Examples:
  ...
  python scripts/tools/eval_curvilinear.py \
    ...
    parser.add_argument(
        "--gt-path", type=str, required=True, help="Path to directory containing ground truth masks"
    )
    parser.add_argument(
        "--pd-path",
        type=str,
    ...
    parser.add_argument(
        "--max-index", type=int, default=200, help="Maximum image index to evaluate. Default: 200"
    )
    parser.add_argument(
        "--pred-pattern",
        type=str,
